...
You may programmatically manage layers via Enonic functions, using the https://developer.enonic.com/docs/code/stable/libraries/lib-project[project library].
