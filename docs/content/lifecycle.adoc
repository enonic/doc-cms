...
Full audit properties (`creator`, `createdTime`, `modifier`, `modifiedTime`, `owner`, `_timestamp`) are documented under <<../content#standard_properties, standard content properties>>.
