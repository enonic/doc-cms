...
TIP: You may also render fragments via Enonic functions and https://developer.enonic.com/docs/code/stable/web/sites/mappings[mapping] using `<match>type:'portal:fragment'</match>`.
