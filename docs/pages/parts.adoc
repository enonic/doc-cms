...
Like pages and layouts, parts needs a descriptor. Place the descriptor in your project as follows: `src/main/resources/site/parts/<part-name>/<part-name>.yaml`.
