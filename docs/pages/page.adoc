...
.An expanded page form with regions and components
image::component-tree.png[Page component tree structure, the regions are listed with capitalized names and do not have icons, 546w]
...
.A page with layouts and regions
image::regions.png[a default page, with a single main region and two layouts with their respective regions listed - some regions are empty and the visual editor shows the empty dropzones for these, 1440w]
