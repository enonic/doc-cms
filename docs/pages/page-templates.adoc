...
Page templates may act as a base setup when creating new custom pages, but a more powerful application is to let editors control the presentation/page setup of other structured content types like Articles.
