...
See the https://developer.enonic.com/docs/xp/stable/storage/aggregations[XP aggregation reference] for the underlying DSL semantics, and the https://developer.enonic.com/docs/guillotine/stable[Guillotine documentation] for the full GraphQL schema.
