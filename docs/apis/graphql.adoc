...
The GraphQL API is Enonic's primary headless API. It is provided by https://developer.enonic.com/docs/guillotine[Guillotine], a separately versioned Enonic app that exposes your CMS content as a typed GraphQL schema.
...
For the full schema reference, query syntax, and configuration options, see the https://developer.enonic.com/docs/guillotine[Guillotine documentation].
...
For the descriptor format and resolver API, see the https://developer.enonic.com/docs/guillotine/stable/extending[Guillotine extension documentation].
