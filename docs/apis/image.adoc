...
The Image API provides real-time processing and delivery of bitmap images from media content.
...
The Image API enables real-time processing and delivery of rasterized RGB/RGBa image media.
...
Example of an image URL on the root of a live site behind  <<../../deployment/vhosts#virtual-hosts,Virtual Host>>:
----
