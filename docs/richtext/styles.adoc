...
<1> The optional `css` property references a file in your app's `/src/main/resources/assets/` folder. The CSS declared in this file will be loaded into Content Studio's rich text editor to provide client-side styling.

<2> Each image style declares a custom style that can be applied to images inserted in the rich text editor.
+
