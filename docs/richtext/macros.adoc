...
TIP: The macro texts (title, description, label and helpText from form input types) can be provided in multiple languages. Visit <<../schemas/i18n#, Schema localization>> for more details.
