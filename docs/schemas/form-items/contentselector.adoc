...
The stored value is the content ID (string) of the referenced item. When multiple selections are allowed, the value is an array.

.Single reference
[source,JSON]
----
{
  "mycontentselector": "f3076b5c-ea45-4c8b-8c06-1f87b8d8cdd9"
}
----
