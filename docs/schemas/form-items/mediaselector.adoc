...
The stored value is the content ID (string) of the selected media item. Like <<contentselector#, ContentSelector>>, the value is a reference to the media content item.

[source,JSON]
----
{
  "mymedia": "f3076b5c-ea45-4c8b-8c06-1f87b8d8cdd9"
}
----
