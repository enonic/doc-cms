...
NOTE: Schema localization uses the same properties file format as the rest of XP. Please consult the https://developer.enonic.com/docs/code/stable/fundamentals/i18n[localization docs] for more details.
...
* helpText
* description
* displayNamePlaceholder (<<../content/content-types#display-name, content types>> only)
